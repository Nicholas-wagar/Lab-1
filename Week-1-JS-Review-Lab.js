...
function realtorFees (num) {
  return (listings[num].price <= 450000)? (2.5/100)* listings[num].price:(2/100)* listings[num].price;
};

console.log(realtorFees(2));
console.log(realtorFees(6));
